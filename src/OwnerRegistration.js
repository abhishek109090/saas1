...
export default function AgentRegistration() {
  ...
  const handleSubmit = (e) => {
    ...
    const ownerId = Math.floor(10000000 + Math.random() * 90000000);
    ...
    axios
      .post('http://3.109.145.125:9001/Owner', formData, {
        headers: {
        ...
        emailjs
          .send(
            ...
            'template_3wveuz6',
            {
              ...
              ownerId: ownerId, // Include the owner ID in the email template data
            },
            'q5nhqMCBFfD5LBjv9'
          )
          .then(
            (result) => {
              console.log(result.text);
              window.alert('OTP sent successfully with Owner ID: ' + ownerId);
            },
            (error) => {
              console.log(error.text);
              window.alert('Error sending OTP.');
          ...
          <form onSubmit={handleSubmit} encType="multipart/form-data">
            ...
            <div className="grid-container-1">
              <div><label>1. Owner Name</label>
                <input type="text" placeholder="Enter Name" value={ownername} disabled={verifyOtp}
                  onInput={(e) => {
              ...
              <div> <label htmlFor="text">2. Email</label>
                <input type="email" value={owneremail} disabled={verifyOtp}
              ...
              <div> <label className="form-label">3. Owner Type</label>
                <select
                  className=" form-control"
                  value={userType} disabled={verifyOtp}
              ...
              <div>
                ...
                <input
                  ...
                  value={phonenumber} disabled={verifyOtp}
              ...
              <div> <label htmlFor="text">6. Bank Name</label>
                <input type="text" value={bankName} style={{ textTransform: 'capitalize' }} maxLength={40}
                  ...
                  }} placeholder="Enter Holder Name" disabled={verifyOtp}
              ...
              <div> <label htmlFor="text">7. Account Holder Name</label>
                <input type="text" value={holderName} style={{ textTransform: 'capitalize' }} disabled={verifyOtp} maxLength={40}
                  onInput={(e) => {
                    e.target.value = e.target.value.replace(/[^A-Za-z\s]+/g, '');
              ...
              <div> <label htmlFor="text">8. Bank Account Number</label>
                <input type="text" value={accNumber} disabled={verifyOtp}
              ...
              <div> <label htmlFor="text">9. IFSC Code</label>
                <input type="text" value={bankIfsc} disabled={verifyOtp}
              ...
              <div> <label htmlFor="text">10. Aadhar Number </label>
                <input
                  type="text"
                  className="form-control"
                  placeholder="XXXX XXXX XXXX" disabled={verifyOtp}
              ...
              <div>  <label htmlFor="text">11. Upload Aadhar Card</label>
                <input type="file"
                  className="form-control" disabled={verifyOtp}
              ...
              <div>  <label htmlFor="text">13. Upload PAN Card</label>
                <input type="file"disabled={verifyOtp}
              ...
              <div><label htmlFor="text">14. Door No</label>
                <input type="text" value={doorNo} disabled={verifyOtp}style={{ textTransform: 'capitalize' }}
              ...
              <div><label htmlFor="text">15. Street</label>
                <input type="text" value={street}disabled={verifyOtp} style={{ textTransform: 'capitalize' }}
                  className="form-control" onInput={(e) => {
                    e.target.value = e.target.value.replace(/[^A-Za-z\s]+/g, '');
              ...
              <div><label htmlFor="text">16. Land Mark</label>
                <input type="text" value={landmark}disabled={verifyOtp} style={{ textTransform: 'capitalize' }}
                  className="form-control" onInput={(e) => {
                    e.target.value = e.target.value.replace(/[^A-Za-z\s]+/g, '');
              ...
              <div><label htmlFor="text">17. Village</label>
                <input type="text" value={village} disabled={verifyOtp}style={{ textTransform: 'capitalize' }}
                  className="form-control" onInput={(e) => {
                    e.target.value = e.target.value.replace(/[^A-Za-z\s]+/g, '');
              ...
              <div><label htmlFor="text">18. Pincode</label>
                <input type="text" value={pincode}disabled={verifyOtp}
                  className="form-control" onInput={(e) => {
                    e.target.value = e.target.value.replace(/\D/g, ''); // Allow only digits
              ...
              <div><label htmlFor="text">19. Mandal</label>
                <input type="text" value={mandal}disabled={verifyOtp} style={{ textTransform: 'capitalize' }}
                  className="form-control" onInput={(e) => {
                    e.target.value = e.target.value.replace(/[^A-Za-z\s]+/g, '');
              ...
              <div><label htmlFor="text">20. District</label>
                <input type="text" value={district} disabled={verifyOtp}style={{ textTransform: 'capitalize' }}
                  className="form-control" onInput={(e) => {
                    e.target.value = e.target.value.replace(/[^A-Za-z\s]+/g, '');
              ...
              <div><label htmlFor="text">21. State</label>
                <input type="text" value={state} disabled={verifyOtp}style={{ textTransform: 'capitalize' }}
                  className="form-control" onInput={(e) => {
                    e.target.value = e.target.value.replace(/[^A-Za-z\s]+/g, '');
