...
export default function AgentRegistration() {
   ...
   return Object.keys(newErrors).length === 0;
      ...
      const handleSubmit = (e) => {
        ...
        axios
          .post('http://3.109.145.125:9001/Agent', formData, {
            headers: {
        ...
        <div>
            ...
            <div className="hello-1"  >
                <div className="hii-1">
                        ...
                        <h2  className='txt' style={{fontFamily:'Segoe UI',textShadow:'1px 2px 2px gray',textAlign:'center'}}>Agent Registration</h2>
                    <form onSubmit={handleSubmit} encType="multipart/form-data"  >
                        ...
                        <div className="grid-container-1">
                            ...
                            <div>
                               <label htmlFor="text">3. Mobile Number</label>
                            ...
                            <br/>
                                <input type="text" value={pancardNumber} className='form-control'
                        ...
                        {errors.name &&  <div className="text-danger">{errors.name}</div>}
                           <button type="submit" id='register-submit-button' className='btn   btn-primary mb-3 mt-2 p-2  ' style={{alignItems:'center',fontWeight:'bold'}}>Submit</button>
                    </form>
                </div>
            </div>
        </div>
