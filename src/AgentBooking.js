...
function AgentBooking() {
  ...
  useEffect(() => {
    if (crn && phonenumber) {
      ...
      axios.get('https://mynode.trucksbooking.in/booking1', {
        params: {
          crn: crn,
  ...
  const handleCancelBooking = (bookingId) => {
    ...
    axios.put(`https://mynode.trucksbooking.in/${parsedBookingId}`, { status: 'canceled' })
      .then(() => {
  ...
  const handleSearch = () => {
    axios.get(`https://mynode.trucksbooking.in/Bookings`, {
      params: {
        from,
        to,
      },
  ...
  const handleLoadingOTPVerify = (bookingId) => {
    ...
    axios.put(`https://mynode.trucksbooking.in/loadingstatus/${bookingId}`, {
  ...
  const handleUnloadingOTPVerify = (bookingId) => {
    if (unloadingOTP === '5678') {
      ...
      console.log('Booking ID:', bookingId);
      console.log('Verification Date:', verificationDate);
      axios.put(`https://mynode.trucksbooking.in/unloadingstatus/${bookingId}`, {
