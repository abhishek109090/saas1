...
export default function AgentUpdate() {
  ...
  const handleFormSubmit = (e) => {
    ...
    if (isConfirmed) {
      ...
      axios
        .put(`https://mynode.trucksbooking.in/updateagent`, dataToSend)
        .then(() => {
          // Handle success
  ...
  return (
    <div>
      ...
      <Container className="Agent">
        <h1 className='txt' style={{fontFamily:'Segoe UI',textShadow:'1px 2px 2px gray',marginLeft:'120px',}}>Update Agent Details</h1>
