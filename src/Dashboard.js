...
<Typography variant='h5' className='fade-in-text text-warning'>
Your journey, our commitment <span className='text-light'>-</span> <span className='text-light'> welcome to seamless trucking</span> </Typography> 
      </div>
